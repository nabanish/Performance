...
#
export GOOGLE_APPLICATION_CREDENTIALS=/opt/jmeter/scripts/aesthetic-frame-155821-ce387a284741.json
#
#########################################################################

nohup jmeter -n \
-t /opt/jmeter/scripts/BigQuery_Select.jmx \
-l /opt/jmeter/ST/ST1.jtl \
-Jproject_id=aesthetic-frame-155821 \
-Jdefault_dataset_id=perfbigquery \
-Juser.classpath=/opt/jmeter/lib \
